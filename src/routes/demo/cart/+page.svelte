...
<div class="cart-page">
	<div class="page-header">
		<h1>Shopping Cart</h1>
		{#if !cart.isEmpty}
			<p class="item-count">{cart.totalQuantity} {cart.totalQuantity === 1 ? 'item' : 'items'}</p>
		{/if}
	</div>
		...
		<div class="cart-content">
					...
					{#each cart.items as item (item.id)}
						<article class="cart-item">
							<div class="item-image">
								...
								{:else}
									<div class="image-placeholder">{item.product.name.charAt(0)}</div>
								{/if}
							</div>
			...
			<div class="cart-sidebar">
				...
				<div class="checkout-actions">
					...
					<a href="/demo/products" class="continue-shopping">← Continue Shopping</a>
				</div>
			</div>
		</div>
	{/if}
